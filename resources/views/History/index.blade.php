                        ...
                        <div class="flex flex-shrink-0 items-center w-full h-fit p-3 bg-white rounded-xl shadow-history">
                            ...
                            <div class="w-[70%] pl-2 md:w-[68%]">
                                ...
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <!-- Nama Barang -->
                                    <p class="text-md font-poppins font-semibold sm:text-lg md:text-xl lg:text-3xl"> {{ $history->nama_barang }} </p>
                                ...
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <div class="w-1/2 text-[#244CA5] font-normal">
                                        ...
                                        <!-- Waktu & Tanggal -->
                                        <p class="mb-1 text-xs sm:text-sm md:text-base xl:text-lg"> {{ $history->created_at }} </p>
                                    ...
                                    <div class="flex justify-end w-1/2">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="text-xs font-poppins sm:text-sm md:text-base"> {{ $history->jurusan }} </p>
                                        </div>
