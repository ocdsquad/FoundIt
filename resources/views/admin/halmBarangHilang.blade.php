                ...
                <div class="w-2/3 flex justify-between">
                    ...
                    <div id="modal-dropdown" class="w-[200px] absolute right-3 top-[65px] bg-white rounded-sm shadow-2xl transition-all ease-in-out duration-300 hidden">
                            ...
                            <ul class="flex flex-col p-3">
                                <li class="w-full mb-1 px-2 py-1 rounded-md"><a href="/admin/home" class="text-mons text-sm font-semibold hover:bg-gray-200 block cursor-pointer">Home</a></li>
                                 
                                 <li class="w-full mb-1 px-2 py-1 rounded-md"><a href="/admin/datauser" class="text-mons text-sm font-semibold hover:bg-gray-200 block  cursor-pointer
                                    ">Data User</a></li>

                                <li class="w-full mb-1 px-2 py-1 rounded-md"><a href="/admin/barangtemu" class="text-mons text-sm font-semibold hover:bg-gray-200 block cursor-pointer
                                        ">Data Barang Temu</a></li>

                                <li class="w-full mb-1 px-2 py-1 rounded-md"><a href="/admin/baranghilang" class="text-mons text-sm font-semibold hover:bg-gray-200 block  cursor-pointer
