                    ...
                    <div class="w-full lg:w-[60%]">
                        ...
                        <div class="w-full block lg:hidden">
                            ...
                            <div class="w-[85%] mx-auto md:w-[65%]">
                                <img class="w-full" src="../src/img/registerSticker.png" alt="Image Login">
                            </div>
                        ...
                        <div class="w-full mx-auto sm:w-[90%] sm:p-5 sm:bg-white sm:rounded-2xl md:w-[80%] lg:w-[95%] lg:rounded-none lg:bg-transparent">
                            ...
                            <form class="w-full">
                                ...
                                <div class="w-full mb-3 lg:mb-2">
                                    ...
                                    <input class="w-full p-3 border border-[#8D9EFF] rounded-xl" type="number" id="telepon">
                                </div>
                                ...
                                <div class="w-full mb-3 lg:mb-2">
                                    ...
                                    <input class="w-full p-3 border border-[#8D9EFF] rounded-xl" type="password" id="password">
                                </div>
                                ...
                                <div class="flex gap-3 w-full mb-8 lg:mb-4">
                                    ...
                                    <div class="w-[50%]">
                                        ...
                                        <input class="w-full border border-[#8D9EFF] bg-white rounded-lg py-1 px-2" id="image-profile" type="file" required>
                                    </div>
                                    ...
                                    <div class="w-[50%]">
                                        ...
                                        <input class="w-full border border-[#8D9EFF] bg-white rounded-lg py-1 px-2" id="image-ktm" type="file" required>
                                    </div>

                                </div>

                                <!-- Button -->
                                <button class="w-full py-[14px] font-poppins font-semibold text-black bg-[#8D72E1] rounded-xl block md:text-lg"> DAFTAR </button>
