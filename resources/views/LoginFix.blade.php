                    ...
                    <div class="w-full mt-10 lg:w-[40%] lg:mt-0">
                        ...
                        <div class="w-full mx-auto sm:w-[80%] sm:p-5 sm:bg-white sm:rounded-2xl md:w-[65%] lg:w-[95%] lg:rounded-none lg:bg-transparent">
                            ...
                            <form class="w-full">
                                ...
                                <p class="mt-5 font-poppins font-bold text-[11px] text-center sm:text-xs md:text-sm "> Belum punya akun ? <a href="Register.html" class="text-[#8D72E1] cursor-pointer"> Daftar Sekarang </a> </p>
